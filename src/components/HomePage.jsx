...
import microphonefa from '../assets/microphonefa.svg'
...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Audio<span className='text-green-400 bold'>tize</span></h1>
